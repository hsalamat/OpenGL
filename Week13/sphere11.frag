...
return (Ia + Id + Is) * attenuation;

}

vec4 computeDirectionalLight(DirectionalLight d)
{
...
Id =  d.base.light * d.base.material * lambertTerm;
...
finalColor = computePointLight(pLight) + computeDirectionalLight(dLight);
finalColor.a = 1.0;
