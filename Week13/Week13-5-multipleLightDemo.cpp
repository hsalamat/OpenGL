///////////////////////////////////////////////////////////////////////
//MultipleLight Demo
// Point Light is green and Directional Light is yellow
// Hooman Salamat
///////////////////////////////////////////////////////////////////////
...
PointLight pLight(glm::vec3(0.0f, 0.0f, -1.0f),	// Position.
	...
	glm::vec4(0.0f, 1.0f, 0.0f, 1.0), glm::vec4(1.0f, 0.8f, 0.0f, 1.0f));
...
void init(void)
{
	vertexShaderId = setShader((char*)"vertex", (char*)"sphere11.vert");
	fragmentShaderId = setShader((char*)"fragment", (char*)"sphere11.frag");
...
int main(int argc, char** argv)
{
	...
	glutCreateWindow("Multiple Light");
