...
//
// Perspective view of a color cube using Frustum
//
...
void display(void)
{
	...
	//projection = glm::perspective(glm::radians(60.0f), 4.0f / 3.0f, 1.0f, 100.0f);

	projection = glm::frustum(leftA, rightA, bottom, top, zNear, zFar);
	//projection = glm::frustum(-1.0f, 1.0f, -1.0f, 1.0f, 0.0f, 100.0f); // In world coordinates

	//ansformObject(1.0f, X_AXIS, rotAngle = 0.0 , glm::vec3(0.0f, 0.0f, 0.0f));
...
keyboard(unsigned char key, int x, int y)
{
	...
	case 'x': leftA *= 1.1; rightA *= 1.1; break;
	case 'X': leftA *= 0.9; rightA *= 0.9; break;
