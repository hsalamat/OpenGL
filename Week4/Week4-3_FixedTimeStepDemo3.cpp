...
///////////////////////////////////////////////////////////////////////
//
// FixedTimeStep movement using Glut Timer
...
float timePerFrame = 1.0f/120.0f; //fixed time step
...
void timer(int)
{
	...
	glutTimerFunc(1000 / 120, timer, 0); //ine one second, this function calls itself 60 times
}
