/** @file Week12-6-ShinenessDemo.cpp
 *  @brief Using Shape.h + Light.h
 *  @note press WASD to ...
 *  @note press arrow keys to ...
 *  @note move mouse to yaw and pitch
 *  @attention we are using triangle3 vertex and fragment shaders!
...
// Light variables.
AmbientLight aLight(glm::vec3(1.0f, 1.0f, 0.0f),	// Ambient color.
	0.1f);							// Ambient strength.

DirectionalLight dLight(glm::vec3(0.0f, 1.0f, 1.0f), // Direction.
	glm::vec3(1.0f, 1.0f, 0.5f),  // Diffuse color.
...
void setupShaders()
{
	vertexShaderId = setShader((char*)"vertex", (char*)"triangles3.vert");
	fragmentShaderId = setShader((char*)"fragment", (char*)"triangles3.frag");
