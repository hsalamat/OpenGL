/** @file Week12-2-PhongShading-PhongReflection.cpp
 *  @brief Phong Shading (Fragment Shader) + Phong Reflection Model (Ambient + Diffuse + Specular)
...
glm::vec4 lightPosition = glm::vec4(0.0f, 1.0f, 0.0f, 1.0f);
